...
// ── Async Gmail preflight — App Password auth ────────────────────────────
let _gmailAuthMode = null; // 'apppass' | null
...
// CTS BPO logo — inline PNG encoded as base64 so it renders in all email clients
// without needing an externally hosted URL
const LOGO_B64 = 'data:image/png;base64,';
...
const header = (tagline = 'Professional Business Process Outsourcing') => `
  ...
  ">
    ...
    ">
      <!-- CTS BPO Logo — transparent PNG, proportional 3:2 -->
      <img
        src="${LOGO_B64}"
        alt="CTS BPO Solutions"
        width="300"
        height="200"
        style="display:block;margin:0 auto 10px;max-width:300px;height:auto"
      />
      <!-- Divider -->
...
const footer = () => `
  ...
  ">
    ...
    <div style="
      ...
      font-family:'Segoe UI',Inter,Arial,sans-serif;
    ">
      <!-- Logo small — transparent PNG, proportional 3:2 -->
      <img
        src="${LOGO_B64}"
        alt="CTS BPO"
        width="180"
        height="120"
        style="display:block;margin:0 auto 10px;max-width:180px;height:auto"
      />
...
const serviceGrid = () => `
  <table style="width:100%;border-collapse:collapse;font-size:13px;margin:4px 0">
    ...
    <tr><td style="padding:5px 0">✅ <strong>Document Translation</strong> — 100+ languages, quality-assured</td></tr>
    ...
    <tr><td style="padding:5px 0">✅ <strong>Document Data Extraction</strong> — Forms, invoices, scanned PDFs</td></tr>
  </table>`;

const pillsRow = () => `
  <div style="display:flex;gap:10px;flex-wrap:wrap;margin:20px 0">
    ${[['⚡','Fast','24–48 hr turnaround'],['🔒','Secure','GDPR &amp; POPIA'],['✅','QA Assured','Every task reviewed'],['💰','Affordable','Up to 60% saving']].map(([i,t,d])=>`
        ...
        <div style="padding:36px">
          ...
          <table style="width:100%;border-collapse:collapse;font-size:14px;margin:16px 0">
            ...
            <tr>
              ...
              <td style="padding:10px 14px;border:1px solid #e2e8f0">~$130</td>
            </tr>
            <tr style="background:#f8fafc">
              ...
              <td style="padding:10px 14px;border:1px solid #e2e8f0">~$480</td>
            </tr>
            <tr>
        ...
        <div style="padding:36px">
          ...
          <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;padding:20px;margin:16px 0;font-size:14px">
            <table style="width:100%;border-collapse:collapse">
              ...
              <tr><td style="padding:6px 0;color:#64748b">QA Standard:</td><td><strong>Quality-reviewed + human sign-off</strong></td></tr>
      ...
      html: wrapper(`
        ...
        <div style="padding:36px">
          ...
          <ol style="font-size:14px;line-height:2;padding-left:20px;color:#334155">
            ...
            <li>Work is processed and thoroughly quality-checked</li>
      ...
      html: wrapper(`
        ...
        <div style="padding:36px">
          ...
          <p style="font-size:15px;line-height:1.7;margin:0 0 16px">
            ...
            completed and thoroughly quality-checked by our expert team.
          </p>
